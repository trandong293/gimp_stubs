...
class ConfigInterface(GObject.GInterface):
    ...
    @staticmethod
    def serialize_value(
        value: GObject.Value, str: GLib.String, escaped: bool
    ) -> bool: ...
    @staticmethod
...
class ColorManagedInterface(gi.Struct):
    ...
    @property
    def get_icc_profile(self) -> Any: ...
    @property
    def profile_changed(self) -> Any: ...
    @property
    def simulation_profile_changed(self) -> Any: ...
    @property
    def simulation_intent_changed(self) -> Any: ...
    @property
    def simulation_bpc_changed(self) -> Any: ...
    @property
    def get_color_profile(self) -> Any: ...
    @property
    def get_simulation_profile(self) -> Any: ...
    @property
    def get_simulation_intent(self) -> Any: ...
    @property
    def get_simulation_bpc(self) -> Any: ...
...
class ConfigWriter(gi.Boxed):
    ...
    @classmethod
    def new_from_string(cls, string: GLib.String) -> ConfigWriter | None: ...
    def close(self) -> None: ...
...
class EnumDesc(gi.Struct):
    ...
    def value(self) -> Any: ...
    @property
    def value_desc(self) -> Any: ...
    @property
    def value_help(self) -> Any: ...
...
class PixPipeParams(gi.Struct):
    ...
    def rows(self) -> Any: ...
    @property
    def cellwidth(self) -> Any: ...
    @property
    def cellheight(self) -> Any: ...
    @property
...
class PlugInClass(gi.Struct):
    ...
    def parent_class(self) -> Any: ...
    @property
    def query_procedures(self) -> Any: ...
    @property
    def init_procedures(self) -> Any: ...
    @property
    def create_procedure(self) -> Any: ...
    @property
    def quit(self) -> Any: ...
    @property
    def set_i18n(self) -> Any: ...
    @property
    def _gimp_reserved0(self) -> Any: ...
    @property
    def _gimp_reserved1(self) -> Any: ...
...
class VectorLoadData(gi.Struct):
    ...
    def width(self) -> Any: ...
    @property
    def width_unit(self) -> Any: ...
    @property
    def exact_width(self) -> Any: ...
    @property
    def height(self) -> Any: ...
    @property
    def height_unit(self) -> Any: ...
    @property
    def exact_height(self) -> Any: ...
    @property
    def correct_ratio(self) -> Any: ...
    @property
    def pixel_density(self) -> Any: ...
    @property
    def density_unit(self) -> Any: ...
    @property
    def exact_density(self) -> Any: ...
