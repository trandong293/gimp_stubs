...
class Color(GObject.Object):
    ...
    @property
    def priv(self) -> ColorPrivate: ...

class TileSource(GObject.Object):
    @property
    def parent_instance(self) -> GObject.Object: ...
    @property
    def command(self) -> TileSourceCommand: ...
    @property
...
class TileHandler(TileSource):
    ...
    @property
    def parent_instance(self) -> TileSource: ...
    @property
    def source(self) -> TileSource: ...
    @property
    def priv(self) -> TileHandlerPrivate: ...
...
class AudioFragment(GObject.Object):
    ...
    def data(self) -> float: ...
    @property
    def priv(self) -> AudioFragmentPrivate: ...
...
class BufferIterator(gi.Struct):
    ...
    def length(self) -> int: ...
    @property
    def priv(self) -> BufferIteratorPriv: ...
    @property
    def items(self) -> BufferIteratorItem: ...
...
class Lookup(gi.Struct):
    @property
    def function(self) -> LookupFunction: ...
    @property
    def data(self) -> typing.Any: ...
    @property
    def shift(self) -> int: ...
    @property
    def positive_min(self) -> int: ...
    @property
    def positive_max(self) -> int: ...
    @property
    def negative_min(self) -> int: ...
    @property
    def negative_max(self) -> int: ...
    @property
...
class MetadataHashClass(gi.Struct):
    @property
    def parent_class(self) -> MetadataStoreClass: ...

class MetadataInterface(gi.Struct):
    @property
    def base_iface(self) -> GObject.TypeInterface: ...
    @property
    def register_map(self) -> object: ...
    @property
    def set_resolution(self) -> object: ...
    @property
    def get_resolution(self) -> object: ...
    @property
    def iter_lookup(self) -> object: ...
    @property
    def iter_init(self) -> object: ...
    @property
    def iter_next(self) -> object: ...
    @property
    def iter_set_value(self) -> object: ...
    @property
    def iter_get_value(self) -> object: ...
...
class MetadataIter(gi.Struct):
    ...
    @property
    def user_data2(self) -> typing.Any: ...
    @property
    def user_data3(self) -> typing.Any: ...
...
class MetadataMap(gi.Struct):
    ...
    def name(self) -> str: ...
    @property
    def transform(self) -> GObject.ValueTransform: ...
...
class MetadataStoreClass(gi.Struct):
    ...
    @property
    def has_value(self) -> object: ...
    @property
    def register_hook(self) -> object: ...
    @property
...
class ParamSpecDouble(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecDouble: ...
    @property
    def ui_minimum(self) -> float: ...
    @property
    def ui_maximum(self) -> float: ...
    @property
    def ui_gamma(self) -> float: ...
    @property
    def ui_step_small(self) -> float: ...
    @property
    def ui_step_big(self) -> float: ...
    @property
    def ui_digits(self) -> int: ...
    def set_digits(self, digits: int) -> None: ...
    def set_steps(self, small_step: float, big_step: float) -> None: ...

class ParamSpecEnum(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecEnum: ...
    @property
    def excluded_values(self) -> GLib.SList: ...
    def exclude_value(self, value: int) -> None: ...

class ParamSpecFilePath(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecString: ...
    @property
    def no_validate(self) -> int: ...
    @property
    def null_ok(self) -> int: ...

class ParamSpecFormat(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecPointer: ...

class ParamSpecInt(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecInt: ...
    @property
    def ui_minimum(self) -> int: ...
    @property
    def ui_maximum(self) -> int: ...
    @property
    def ui_gamma(self) -> float: ...
    @property
    def ui_step_small(self) -> int: ...
    @property
    def ui_step_big(self) -> int: ...
    def set_steps(self, small_step: int, big_step: int) -> None: ...

class ParamSpecSeed(gi.Struct):
    @property
    def parent_instance(self) -> GObject.ParamSpecUInt: ...
    @property
    def ui_minimum(self) -> int: ...
    @property
    def ui_maximum(self) -> int: ...
...
class TileBackend(TileSource):
    ...
    def parent_instance(self) -> TileSource: ...
    @property
    def priv(self) -> TileBackendPrivate: ...

class TileBackendClass(gi.Struct):
    @property
    def parent_class(self) -> TileSourceClass: ...
    @property
    def padding(self) -> typing.Any: ...
...
def stats() -> Stats: ...
def TileSourceCommand(gegl_tile_source: TileSource, command: TileCommand, x: int, y: int, z: int, data: Any) -> Any: ...
def LookupFunction(value: float, data: Any) -> float: ...
